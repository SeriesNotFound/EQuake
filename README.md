...
> [!NOTE]
> **安全提示**：由于使用易语言开发，本软件可能被误报为病毒。这是此类程序的普遍现象，目前360安全软件已确认解除误报。请您在使用时将本软件添加至杀毒软件的信任名单。如有疑虑，请联系我们（QQ群：1053492801 / 邮箱：3853402470@qq.com）。
...
## 开源协议
本仓库公开的代码（GeoJson 解析器）采用 MIT 许可证；主程序为闭源专有软件。
